...
//					rowBounds는 db의 rownum같은것 여기서 안쓸거면 쿼리문에서 rownum작업 해줘야함
	...
	public ArrayList<Board> searchList(SqlSession sqlSession, String keyField, String keyword, int nowPage, PageInfo pi) {
		int limit = pi.getNumPerPage();
		int offset = (nowPage-1)*limit;
		RowBounds rowBounds = new RowBounds(offset, limit);
		return (ArrayList)sqlSession.searchList("boardMapper.searchList", null, rowBounds);
	}
